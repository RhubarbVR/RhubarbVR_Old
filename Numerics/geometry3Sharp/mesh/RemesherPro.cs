	...
	public class RemesherPro : Remesher
	{
		...
		protected virtual void TrackedFaceProjectionPass()
		{
			...
			Action<int> process_triangle = (tid) =>
			{
				...
				v0 = triF.ToFrameP(ref v0);
				v1 = triF.ToFrameP(ref v1);
				v2 = triF.ToFrameP(ref v2);
				triF.AlignAxis(2, (Vector3f)projNormal);
				triF.Origin = (Vector3f)projPos;
				v0 = triF.FromFrameP(ref v0);
				v1 = triF.FromFrameP(ref v1);
				v2 = triF.FromFrameP(ref v2);
				...
				vBufferV[tv.a] += w * v0;
				vBufferVWeights[tv.a] += w;
				vBufferV[tv.b] += w * v1;
				vBufferVWeights[tv.b] += w;
				vBufferV[tv.c] += w * v2;
				vBufferVWeights[tv.c] += w;
				buffer_lock.Exit();
			};
