		...
		public override MeshGenerator Generate()
		{
			...
			else
			{
				...
				for (int fi = 0; fi < 6; ++fi)
				{
					...
					Vector3d v00 = boxvertices[c00];
					Vector3i vi00 = intvertices[c00];
					Vector3d v01 = boxvertices[c01];
					Vector3i vi01 = intvertices[c01];
					Vector3d v11 = boxvertices[c11];
					Vector3i vi11 = intvertices[c11];
					Vector3d v10 = boxvertices[c10];
					Vector3i vi10 = intvertices[c10];
