...
namespace RNumerics
{
	...
	public class MeshSignedDistanceGrid
	{
							 ...
							 DenseGrid3f distances, int exact_band)
		{
			...
			if (DebugPrint)
				System.Console.WriteLine("done narrow-band tagging");
			...
			if (DebugPrint)
				System.Console.WriteLine("done distances");
							 ...
							 DenseGrid3f distances, int exact_band)
		{
			...
			if (DebugPrint)
				System.Console.WriteLine("done vertices");
			if (CancelF())
				return;
			...
			if (DebugPrint)
				System.Console.WriteLine("done floodfill");
			if (CancelF())
				return;
