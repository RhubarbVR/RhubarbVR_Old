...
namespace Org.OpenAPITools.Model
{
    ...
    /// PublicUser
    /// </summary>
    [DataContract(Name = "PublicUser")]
    public partial class PublicUser : IEquatable<PublicUser>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as PublicUser);
        }

        /// <summary>
        /// Returns true if PublicUser instances are equal
        /// </summary>
        /// <param name="input">Instance of PublicUser to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PublicUser input)
        {
            if (input == null)
                return false;
