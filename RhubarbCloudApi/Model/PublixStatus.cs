...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class PublixStatus : IEquatable<PublixStatus>, IValidatableObject
    {
        ...
        public PublixStatus(string uuid = default(string), int onlinelevel = default(int), string customstatus = default(string), string focusedsession = default(string), List<string> sessions = default(List<string>), string host = default(string), string outputdevice = default(string), string version = default(string), bool currentsessionhidden = default(bool), string currenthosting = default(string), int currentsessionaccesslevel = default(int), DateTime laststatus = default(DateTime), bool ismobile = default(bool))
        {
            this.Uuid = uuid;
