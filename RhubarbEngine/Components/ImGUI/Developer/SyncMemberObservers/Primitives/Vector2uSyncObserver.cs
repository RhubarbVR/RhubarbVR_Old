...
namespace RhubarbEngine.Components.ImGUI
{
	...
	public class Vector2uSyncObserver : UIWidget, IPropertiesElement
	{
		public Sync<string> fieldName;

		public SyncRef<Sync<Vector2u>> target;

		public override void BuildSyncObjs(bool newRefIds)
		{
			base.BuildSyncObjs(newRefIds);
			target = new SyncRef<Sync<Vector2u>>(this, newRefIds);
			fieldName = new Sync<string>(this, newRefIds);
		}


		public Vector2uSyncObserver(IWorldObject _parent, bool newRefIds = true) : base(_parent, newRefIds)
		{

		}
		public Vector2uSyncObserver()
		{
		}
		...
		public unsafe override void ImguiRender(ImGuiRenderer imGuiRenderer, ImGUICanvas canvas)
		{
			...
			var val = target.Target?.Value ?? Vector2u.Zero;
			if (ImGui.DragScalarN((fieldName.Value ?? "null") + $"##{ReferenceID.id}", ImGuiDataType.U32, (IntPtr)(&val), 2, 1))
			{
			...
			if (Changeboarder)
			{
				...
				{
                    var e = (Sync<Vector2u>)source.Referencer.Target;
					if (target.Target != null)
                    {
