...
namespace RhubarbEngine.Components.ImGUI
{
	...
	public class Vector3uSyncObserver : UIWidget, IPropertiesElement
	{
        ...
        public unsafe override void ImguiRender(ImGuiRenderer imGuiRenderer, ImGUICanvas canvas)
		{
			...
			if (ImGui.DragScalarN((fieldName.Value ?? "null") + $"##{ReferenceID.id}", ImGuiDataType.U32, (IntPtr)(&val), 3, 1))
			{
			...
			if (Changeboarder)
			{
				...
				{
					var e = (Sync<Vector3u>)source.HolderReferen;
					if (target.Target != null)
                    {
