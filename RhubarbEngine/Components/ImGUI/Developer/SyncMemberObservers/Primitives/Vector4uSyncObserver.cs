...
namespace RhubarbEngine.Components.ImGUI
{
	...
	public class Vector4uSyncObserver : UIWidget, IPropertiesElement
	{
		public Sync<string> fieldName;

		public SyncRef<Sync<Vector4u>> target;

		public override void BuildSyncObjs(bool newRefIds)
		{
			base.BuildSyncObjs(newRefIds);
			target = new SyncRef<Sync<Vector4u>>(this, newRefIds);
			fieldName = new Sync<string>(this, newRefIds);
		}


		public Vector4uSyncObserver(IWorldObject _parent, bool newRefIds = true) : base(_parent, newRefIds)
		{

		}
		public Vector4uSyncObserver()
		{
		}
		...
		public unsafe override void ImguiRender(ImGuiRenderer imGuiRenderer, ImGUICanvas canvas)
		{
			...
			if (Changeboarder)
			{
				...
				{
					var e = (Sync<Vector4u>)source.Referencer.Target;
					if (target.Target != null)
                    {
