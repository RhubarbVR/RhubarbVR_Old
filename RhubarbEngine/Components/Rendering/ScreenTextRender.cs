...
namespace RhubarbEngine.Components.Rendering
{
    ...
    public class ScreenTextRender : Renderable
    {
        ...
        public ScreenTextRender(IWorldObject _parent, bool newRefIds = true) : base(_parent, newRefIds)
        {

        }
        public ScreenTextRender()
        {
        }
        ...
        public override void Render(GraphicsDevice gd, CommandList cl, UBO ubo, Framebuffer framebuffer)
        {
            ...
            _textRenderer.UpdateVeldridStuff(cl, framebuffer,framebuffer.Height, framebuffer.Width);
        ...
        {
            return RenderOrderKey.Create(0, 0);
