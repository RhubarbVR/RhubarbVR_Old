...
namespace SteamAudio
{
    ...
    public static partial class IPL
    {
        ...
        /// <param name="dst">The interleaved array to write into.</param>
        [DllImport(Library, EntryPoint = "iplAudioBufferInterleave", CallingConvention = CallingConvention.Cdecl)]
        public static extern void AudioBufferInterleave(IPL._IPLContext_t context, ref IPL.AudioBuffer src, IntPtr dst);
        ...
        /// <param name="dst">The audio buffer to write into.</param>
        [DllImport(Library, EntryPoint = "iplAudioBufferDeinterleave", CallingConvention = CallingConvention.Cdecl)]
        public static extern void AudioBufferDeinterleave(IPL._IPLContext_t context, IntPtr src, ref IPL.AudioBuffer dst);
        /// <summary>
        ...
        {
            ref IPL.IContext Retain();
            
            void Release();
            
            void SetTelemetryAPI(IntPtr telemetryAPI);
            
            IPL.Vector3 CalculateRelativeDirection(IPL.Vector3 sourcePosition, IPL.Vector3 listenerPosition, IPL.Vector3 listenerAhead, IPL.Vector3 listenerUp);
            
            IPL.Error CreateSerializedObject(ref IPL.SerializedObjectSettings settings, out IntPtr serializedObject);
            
            public interface ISerializedObject
            {
                ref IPL.IContext.ISerializedObject Retain();
            ...
            IPL.Error CreateEmbreeDevice(ref IPL.EmbreeDeviceSettings settings, out IntPtr device);
            
            public interface IEmbreeDevice
            {
                ref IPL.IContext.IEmbreeDevice Retain();
                
                void Release();
            }
            
            IPL.Error CreateOpenCLDeviceList(ref IPL.OpenCLDeviceSettings settings, out IntPtr deviceList);
            
            public interface IOpenCLDeviceList
            {
                ref IPL.IContext.IOpenCLDeviceList Retain();
                
                void Release();
                
                int GetNumDevices();
                
                void GetDeviceDesc(int index, ref IPL.OpenCLDeviceDesc deviceDesc);
            }
            
            IPL.Error CreateOpenCLDevice(ref IPL.IContext.IOpenCLDeviceList deviceList, int index, out IntPtr device);
            
            public interface IOpenCLDevice
            {
                ref IPL.IContext.IOpenCLDevice Retain();
                
                void Release();
                
                IPL.Error CreateRadeonRaysDevice(ref IPL.RadeonRaysDeviceSettings settings, out IntPtr device);
                
                public interface IRadeonRaysDevice
                {
                    ref IPL.IContext.IOpenCLDevice.IRadeonRaysDevice Retain();
                    
                    void Release();
                }
                
                IPL.Error CreateTrueAudioNextDevice(ref IPL.TrueAudioNextDeviceSettings settings, out IntPtr device);
                
                public interface ITrueAudioNextDevice
                {
                    ref IPL.IContext.IOpenCLDevice.ITrueAudioNextDevice Retain();
                    
                    void Release();
                }
            }
            
            IPL.Error CreateOpenCLDeviceFromExisting(IntPtr convolutionQueue, IntPtr irUpdateQueue, out IntPtr device);
            
            IPL.Error CreateScene(ref IPL.SceneSettings settings, out IntPtr scene);
            
            public interface IScene
            {
                ref IPL.IContext.IScene Retain();
                
                void Release();
                
                void Save(ref IPL.IContext.ISerializedObject serializedObject);
                
                void SaveOBJ([MarshalAs(UnmanagedType.LPStr)] string fileBaseName);
                
                void Commit();
                
                IPL.Error CreateStaticMesh(ref IPL.StaticMeshSettings settings, out IntPtr staticMesh);
                
                public interface IStaticMesh
                {
                    ref IPL.IContext.IScene.IStaticMesh Retain();
                    
                    void Release();
                    
                    void Save(ref IPL.IContext.ISerializedObject serializedObject);
                    
                    void Add(ref IPL.IContext.IScene scene);
                    
                    void Remove(ref IPL.IContext.IScene scene);
                }
                
                IPL.Error LoadStaticMesh(ref IPL.IContext.ISerializedObject serializedObject, IPL.ProgressCallback progressCallback, IntPtr userData, out IntPtr staticMesh);
                
                IPL.Error CreateInstancedMesh(ref IPL.InstancedMeshSettings settings, out IntPtr instancedMesh);
                
                public interface IInstancedMesh
                {
                    ref IPL.IContext.IScene.IInstancedMesh Retain();
                    ...
                    void UpdateTransform(ref IPL.IContext.IScene scene, IPL.Matrix4x4 transform);
                }
            }
            
            IPL.Error LoadScene(ref IPL.SceneSettings settings, ref IPL.IContext.ISerializedObject serializedObject, IPL.ProgressCallback progressCallback, IntPtr userData, out IntPtr scene);
            
            IPL.Error AllocateAudioBuffer(int numChannels, int numSamples, ref IPL.AudioBuffer audioBuffer);
            
            void FreeAudioBuffer(ref IPL.AudioBuffer audioBuffer);
            
            void InterleaveAudioBuffer(ref IPL.AudioBuffer src, ref float dst);
            
            void DeinterleaveAudioBuffer(ref float src, ref IPL.AudioBuffer dst);
            
            void MixAudioBuffer(ref IPL.AudioBuffer @in, ref IPL.AudioBuffer mix);
            
            void DownmixAudioBuffer(ref IPL.AudioBuffer @in, ref IPL.AudioBuffer @out);
            
            void ConvertAmbisonicAudioBuffer(IPL.AmbisonicsType inType, IPL.AmbisonicsType outType, ref IPL.AudioBuffer @in, ref IPL.AudioBuffer @out);
            
            IPL.Error CreateHRTF(ref IPL.AudioSettings audioSettings, ref IPL.HRTFSettings hrtfSettings, out IntPtr hrtf);
            
            public interface IHRTF
            {
                ref IPL.IContext.IHRTF Retain();
                
                void Release();
            }
            
            IPL.Error CreatePanningEffect(ref IPL.AudioSettings audioSettings, ref IPL.PanningEffectSettings effectSettings, out IntPtr effect);
            
            public interface IPanningEffect
            {
                ref IPL.IContext.IPanningEffect Retain();
                
                void Release();
                
                void Reset();
                
                IPL.AudioEffectState Apply(ref IPL.PanningEffectParams @params, ref IPL.AudioBuffer @in, ref IPL.AudioBuffer @out);
            }
            
            IPL.Error CreateBinauralEffect(ref IPL.AudioSettings audioSettings, ref IPL.BinauralEffectSettings effectSettings, out IntPtr effect);
            
            public interface IBinauralEffect
            {
                ref IPL.IContext.IBinauralEffect Retain();
                
                void Release();
                
                void Reset();
                
                IPL.AudioEffectState Apply(ref IPL.BinauralEffectParams @params, ref IPL.AudioBuffer @in, ref IPL.AudioBuffer @out);
            }
            
            IPL.Error CreateVirtualSurroundEffect(ref IPL.AudioSettings audioSettings, ref IPL.VirtualSurroundEffectSettings effectSettings, out IntPtr effect);
            
            public interface IVirtualSurroundEffect
            {
                ref IPL.IContext.IVirtualSurroundEffect Retain();
                
                void Release();
                
                void Reset();
                
                IPL.AudioEffectState Apply(ref IPL.VirtualSurroundEffectParams @params, ref IPL.AudioBuffer @in, ref IPL.AudioBuffer @out);
            }
            
            IPL.Error CreateAmbisonicsEncodeEffect(ref IPL.AudioSettings audioSettings, ref IPL.AmbisonicsEncodeEffectSettings effectSettings, out IntPtr effect);
            
            public interface IAmbisonicsEncodeEffect
            {
                ref IPL.IContext.IAmbisonicsEncodeEffect Retain();
                
                void Release();
                
                void Reset();
                
                IPL.AudioEffectState Apply(ref IPL.AmbisonicsEncodeEffectParams @params, ref IPL.AudioBuffer @in, ref IPL.AudioBuffer @out);
            }
            
            IPL.Error CreateAmbisonicsPanningEffect(ref IPL.AudioSettings audioSettings, ref IPL.AmbisonicsPanningEffectSettings effectSettings, out IntPtr effect);
            
            public interface IAmbisonicsPanningEffect
            {
                ref IPL.IContext.IAmbisonicsPanningEffect Retain();
                
                void Release();
                
                void Reset();
                
                IPL.AudioEffectState Apply(ref IPL.AmbisonicsPanningEffectParams @params, ref IPL.AudioBuffer @in, ref IPL.AudioBuffer @out);
            }
            
            IPL.Error CreateAmbisonicsBinauralEffect(ref IPL.AudioSettings audioSettings, ref IPL.AmbisonicsBinauralEffectSettings effectSettings, out IntPtr effect);
            
            public interface IAmbisonicsBinauralEffect
            {
                ref IPL.IContext.IAmbisonicsBinauralEffect Retain();
                
                void Release();
                
                void Reset();
                
                IPL.AudioEffectState Apply(ref IPL.AmbisonicsBinauralEffectParams @params, ref IPL.AudioBuffer @in, ref IPL.AudioBuffer @out);
            }
            
            IPL.Error CreateAmbisonicsRotationEffect(ref IPL.AudioSettings audioSettings, ref IPL.AmbisonicsRotationEffectSettings effectSettings, out IntPtr effect);
            
            public interface IAmbisonicsRotationEffect
            {
                ref IPL.IContext.IAmbisonicsRotationEffect Retain();
                
                void Release();
                
                void Reset();
                
                IPL.AudioEffectState Apply(ref IPL.AmbisonicsRotationEffectParams @params, ref IPL.AudioBuffer @in, ref IPL.AudioBuffer @out);
            }
            
            IPL.Error CreateAmbisonicsDecodeEffect(ref IPL.AudioSettings audioSettings, ref IPL.AmbisonicsDecodeEffectSettings effectSettings, out IntPtr effect);
            
            public interface IAmbisonicsDecodeEffect
            {
                ref IPL.IContext.IAmbisonicsDecodeEffect Retain();
                
                void Release();
                
                void Reset();
                
                IPL.AudioEffectState Apply(ref IPL.AmbisonicsDecodeEffectParams @params, ref IPL.AudioBuffer @in, ref IPL.AudioBuffer @out);
            }
            
            IPL.Error CreateDirectEffect(ref IPL.AudioSettings audioSettings, ref IPL.DirectEffectSettings effectSettings, out IntPtr effect);
            
            public interface IDirectEffect
            {
                ref IPL.IContext.IDirectEffect Retain();
                
                void Release();
                
                void Reset();
                
                IPL.AudioEffectState Apply(ref IPL.DirectEffectParams @params, ref IPL.AudioBuffer @in, ref IPL.AudioBuffer @out);
            }
            
            IPL.Error CreateReflectionEffect(ref IPL.AudioSettings audioSettings, ref IPL.ReflectionEffectSettings effectSettings, out IntPtr effect);
            
            public interface IReflectionEffect
            {
                ref IPL.IContext.IReflectionEffect Retain();
                
                void Release();
                
                void Reset();
                
                IPL.AudioEffectState Apply(ref IPL.ReflectionEffectParams @params, ref IPL.AudioBuffer @in, ref IPL.AudioBuffer @out, ref IPL.IContext.IReflectionEffect.IReflectionMixer mixer);
                
                public interface IReflectionMixer
                {
                    ref IPL.IContext.IReflectionEffect.IReflectionMixer Retain();
                    
                    void Release();
                    
                    void Reset();
                    
                    IPL.AudioEffectState Apply(ref IPL.ReflectionEffectParams @params, ref IPL.AudioBuffer @out);
                }
            }
            
            IPL.Error CreateReflectionMixer(ref IPL.AudioSettings audioSettings, ref IPL.ReflectionEffectSettings effectSettings, out IntPtr mixer);
            
            IPL.Error CreatePathEffect(ref IPL.AudioSettings audioSettings, ref IPL.PathEffectSettings effectSettings, out IntPtr effect);
            
            public interface IPathEffect
            {
                ref IPL.IContext.IPathEffect Retain();
                
                void Release();
                
                void Reset();
                
                IPL.AudioEffectState Apply(ref IPL.PathEffectParams @params, ref IPL.AudioBuffer @in, ref IPL.AudioBuffer @out);
            }
            
            IPL.Error CreateProbeArray(out IntPtr probeArray);
            
            public interface IProbeArray
            {
                ref IPL.IContext.IProbeArray Retain();
                
                void Release();
                
                void GenerateProbes(ref IPL.IContext.IScene scene, ref IPL.ProbeGenerationParams @params);
                
                int GetNumProbes();
                
                IPL.Sphere GetProbe(int index);
            }
            
            IPL.Error CreateProbeBatch(out IntPtr probeBatch);
            
            public interface IProbeBatch
            {
                ref IPL.IContext.IProbeBatch Retain();
                ...
                void AddProbe(IPL.Sphere probe);
                
                void AddProbeArray(ref IPL.IContext.IProbeArray probeArray);
                
                void RemoveProbe(int index);
                
                void Commit();
                
                void RemoveData(ref IPL.BakedDataIdentifier identifier);
                
                ulong GetDataSize(ref IPL.BakedDataIdentifier identifier);
            }
            
            IPL.Error LoadProbeBatch(ref IPL.IContext.ISerializedObject serializedObject, out IntPtr probeBatch);
            
            void BakeReflections(ref IPL.ReflectionsBakeParams @params, IPL.ProgressCallback progressCallback, IntPtr userData);
            
            void CancelBakeReflections();
            
            void BakePaths(ref IPL.PathBakeParams @params, IPL.ProgressCallback progressCallback, IntPtr userData);
            
            void CancelBakePaths();
            
            IPL.Error CreateSimulator(ref IPL.SimulationSettings settings, out IntPtr simulator);
            
            public interface ISimulator
            {
                ref IPL.IContext.ISimulator Retain();
                
                void Release();
                
                void SetScene(ref IPL.IContext.IScene scene);
                
                void AddProbeBatch(ref IPL.IContext.IProbeBatch probeBatch);
                
                void RemoveProbeBatch(ref IPL.IContext.IProbeBatch probeBatch);
                
                void SetSharedInputs(IPL.SimulationFlags flags, ref IPL.SimulationSharedInputs sharedInputs);
                ...
                IPL.Error CreateSource(ref IPL.SourceSettings settings, out IntPtr source);
                
                public interface ISource
                {
                    ref IPL.IContext.ISimulator.ISource Retain();
                    
                    void Release();
                    
                    void Add(ref IPL.IContext.ISimulator simulator);
                    
                    void Remove(ref IPL.IContext.ISimulator simulator);
                    
                    void SetInputs(IPL.SimulationFlags flags, ref IPL.SimulationInputs inputs);
                    
                    void GetOutputs(IPL.SimulationFlags flags, ref IPL.SimulationOutputs outputs);
                }
            }
            
            float CalculateDistanceAttenuation(IPL.Vector3 source, IPL.Vector3 listener, ref IPL.DistanceAttenuationModel model);
            
            void CalculateAirAbsorption(IPL.Vector3 source, IPL.Vector3 listener, ref IPL.AirAbsorptionModel model, ref float airAbsorption);
            
            float CalculateDirectivity(IPL.CoordinateSpace3 source, IPL.Vector3 listener, ref IPL.Directivity model);
        }
    }
}
